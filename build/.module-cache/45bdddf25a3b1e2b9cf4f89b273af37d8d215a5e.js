    ...
    return (
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "six columns"}, 
            ...
            React.createElement("div", {style: {marginTop:50+"px;"}, className: "row"}, 
              React.createElement(ResultBoxOne, {data: this.state.exone}), 
              React.createElement(Logovs, null), 
              React.createElement(ResultBoxTwo, {data: this.state.extwo})
          )
          )
    );
  }
    ...
    return (
      React.createElement("div", {className: "row"}, 
        React.createElement("div", {className: "twelve columns"}, 
          React.createElement("input", {onChange: this.handleChange, className: "search-input", ref: "filtertextinputone", spellcheck: "false", autocomplete: "off", autocorrect: "off", placeholder: "Search for someone", type: "text"})
        )
      )
    );
  }
...
var SearchBoxTwo = React.createClass({displayName: "SearchBoxTwo",
  handleChange: function() {
    //Use true for first search bar
    this.props.onUserInput(this.refs.filtertextinputtwo.getDOMNode().value, false);
  },
  render: function() {
    return (
      React.createElement("div", {className: "row"}, 
        React.createElement("div", {className: "twelve columns"}, 
          React.createElement("input", {onChange: this.handleChange, className: "search-input", ref: "filtertextinputtwo", spellcheck: "false", autocomplete: "off", autocorrect: "off", placeholder: "Search for someone", type: "text"})
        )
      )
    );
  }
