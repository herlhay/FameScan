  ...
  render: function() {
    return (
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement(ResultBoxOne, {profilepic: "http://ccdn.hiphopdx.com/2014/12/Kanye-West_12-03-2014-300x300.jpg"}), 
          React.createElement(Logovs, null), 
          React.createElement(ResultBoxTwo, {profilepic: "http://24.media.tumblr.com/tumblr_m26pmwNLCo1qc9f21o1_500.jpg"})
        )
      )
    );
  }
      ...
      React.createElement("div", {className: "five columns center"}, 
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "twelve columns"}, 
            React.createElement("img", {className: "avatar", src: this.prop.profilepic, width: "100"})
          )
        ), 
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "twelve columns"}, 
