...
var SearchBoxOne = React.createClass({displayName: "SearchBoxOne",
  getInitialState: function() {
    return {
        filterText: '',
        data: {name: 'Kanye West', networth: '$79,000,000', avatarurl: "http://ccdn.hiphopdx.com/2014/12/Kanye-West_12-03-2014-300x300.jpg"},
    };
  },
...
var SearchBoxTwo = React.createClass({displayName: "SearchBoxTwo",
  ...
  render: function() {
    return (
      React.createElement("div", {class: "five columns"}, 
        React.createElement(GenericSearchBox, {onUserInput: this.handleChange}), 
        React.createElement(SearchResult, {data: this.data})
      )
    );
  }
});
    ...
    return (
      React.createElement("div", {class: "row"}, 
        React.createElement("div", {class: "twelve columns"}, 
          React.createElement("input", {className: "search-input", onChange: this.onUserInput, ref: "filterTextInput", spellcheck: "false", autocomplete: "off", autocorrect: "off", placeholder: "Search for someone", type: "text"})
        )
      )
    );
  }
