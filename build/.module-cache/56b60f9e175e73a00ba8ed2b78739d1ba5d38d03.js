  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "twelve columns"}, 
        ...
        this.state.filterText ?React.createElement(SearchResult, {data: this.state.data}):React.createElement("div", {className: "result-content seperator two columns"}, React.createElement(Luxuries, null))
      )
    );
  }
});
...
var SearchBoxTwo = React.createClass({displayName: "SearchBoxTwo",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "twelve columns"}, 
        React.createElement(GenericSearchBox, {onUserInput: this.handleChange}), 
        this.state.filterText ? React.createElement(SearchResult, {data: this.state.data}):React.createElement("div", {className: "result-content seperator two columns center"}, React.createElement(Luxuries, null))
      )
    );
  }
});
