...
var Searchesapp = React.createClass({displayName: "Searchesapp",
  ...
  handleUserInput: function(filterText, isFirstSearchBar) {
    ...
    if (isFirstSearchBar) {
        //exone: {name: 'Ciara', networth: '$52,000,000', avatarurl: "http://thatgrapejuice.net/wp-content/uploads/2014/01/ciara-album-2014-thatgrapejuice.jpg"}
    } else {
        //extwo: {name: 'Young Thug', networth: '$3,000,000', avatarurl: "http://www.thatunes.com/wp-content/uploads/2015/05/purpose.jpg"}
    }
    this.setState({
        filterText: filterText,
        exone: function(isFirstSearchBar){
          return {name: 'Ciara', networth: '$52,000,000', avatarurl: "http://thatgrapejuice.net/wp-content/uploads/2014/01/ciara-album-2014-thatgrapejuice.jpg"}
        }
    });
  },
  render: function() {
