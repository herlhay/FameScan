    ...
    return (
      React.createElement("div", {class: "row"}, 
        React.createElement("div", {class: "twelve columns"}, 
          React.createElement("input", {className: "search-input", onChange: this.onUserInput, refs: "filterTextInput", spellcheck: "false", autocomplete: "off", autocorrect: "off", placeholder: "Search for someone", type: "text"})
        )
      )
    );
  }
