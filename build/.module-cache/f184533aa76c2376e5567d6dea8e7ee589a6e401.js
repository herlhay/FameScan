...
var SearchBoxOne = React.createClass({displayName: "SearchBoxOne",
  ...
  render: function() {
    return (
        React.createElement(GenericSearchBox, {onUserInput: this.handleUserInput})
    );
  }
});
  ...
  render: function() {
    return (
      React.createElement("div", {class: "five columns"}, 
        React.createElement(GenericSearchBox, {onUserInput: this.onUserInput})
      )
    );
  }
});
...
var GenericSearchBox = React.createClass({displayName: "GenericSearchBox",
  onUserInput: function() {
    //Use true for first search bar
    this.props.handleChange(this.refs.filtertextinput.getDOMNode().value, true);
  },
  render: function() {
    return (
      React.createElement("div", {class: "row"}, 
        React.createElement("div", {class: "twelve columns"}, 
          React.createElement("input", {className: "search-input", ref: "filtertextinput", spellcheck: "false", autocomplete: "off", autocorrect: "off", placeholder: "Search for someone", type: "text"})
        )
      )
    );
  }
