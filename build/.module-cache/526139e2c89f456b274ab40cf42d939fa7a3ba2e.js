  ...
  render: function() {
    return (
      React.createElement("div", {className: "row zoom-in"}, 
        ...
        React.createElement("div", {className: "result-content seperator two columns"}, 
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "twelve columns"}, 
        ...
        this.state.filterText ? React.createElement(SearchResult, {data: this.state.data}):false
      )
    );
  }
});
